...
function isCollidingAABB(hb1, hb2) {
  return (
    hb1.x1 < hb2.x2 && hb1.x2 > hb2.x1 && hb1.y1 < hb2.y2 && hb1.y2 > hb2.y1
  );
}
...
function applyHardBodyCollisionMovementAABB(hb1, hb2) {
  ...
  mass_effect1 *=
    hb2.mass === -1 ? 1 : hb2.mass / Math.max(hb1.mass + hb2.mass, 0.01);
  mass_effect2 *=
    hb1.mass === -1 ? 1 : hb1.mass / Math.max(hb1.mass + hb2.mass, 0.01);
